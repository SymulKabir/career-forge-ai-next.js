      ...
      <div className="mx-auto max-w-[1250px] px-4 py-6 pb-28 sm:px-6 lg:px-8 lg:py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
            Manage your account, career preferences, notifications, privacy, and
            AI experience from one place.
          </p>
        </div>
              ...
              <div className="space-y-5 p-5 sm:p-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 rounded-xl border border-slate-200 bg-slate-50 p-3">
                    {["React", "Next.js", "TypeScript", "Docker"].map(
                      (skill) => (
                        <span
                          key={skill}
              ...
              <div className="divide-y divide-slate-100">
                {[
                  ...
                  },
                  {
                    ...
                    description: "Learn about new CareerForge AI features.",
                    active: false,
                  },
                ].map((item) => (
                  <div
            ...
            <section className="setting-card overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-card">
              <div className="border-b border-slate-100 px-5 py-5 sm:px-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-sm font-bold">AI preferences</h2>
              ...
              <div className="divide-y divide-slate-100">
                ...
                {[
                  ...
                  >
                    ...
                    <button type="button" className="toggle active shrink-0" />
                  </div>
                ))}
              </div>
            </section>
            ...
            <section className="relative overflow-hidden rounded-2xl border border-violet-200 bg-gradient-to-br from-violet-50 via-white to-blue-50 p-6 shadow-card">
              ...
              <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <h2 className="text-xl font-extrabold">Free Plan</h2>

                  <p className="mt-2 max-w-lg text-xs leading-5 text-slate-500">
                    Upgrade to unlock unlimited AI tools, advanced ATS analysis,
                    unlimited cover letters, and premium career insights.
                  </p>
                </div>
              ...
              <div className="relative mt-6 grid gap-3 border-t border-violet-100 pt-5 sm:grid-cols-3">
                <div>
                  <div className="text-lg font-extrabold">3 / 5</div>
                ...
                <div>
                  <div className="text-lg font-extrabold">12 / 20</div>
                  <div className="text-[10px] text-slate-400">Job analyses</div>
                </div>

                <div>
                  <div className="text-lg font-extrabold">2 / 3</div>
                  <div className="text-[10px] text-slate-400">
                    Cover letters
                  </div>
                </div>
