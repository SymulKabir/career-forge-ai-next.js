...
export default function ApplicationsPage() {
  ...
  const totalPages = Math.max(1, Math.ceil(filteredApplications.length / 6));
    ...
    <div className="mx-auto max-w-[1500px] space-y-6 px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-slate-500">
              Track every job application, follow your progress, and never miss
      ...
      <section className="grid grid-cols-2 gap-4 lg:grid-cols-5">
        ...
        <div className="card-hover rounded-2xl border border-slate-200 bg-white p-5 shadow-card">
          ...
          <div className="mt-1 text-xs text-slate-400">Total applications</div>
        </div>
        ...
        <div className="card-hover rounded-2xl border border-slate-200 bg-white p-5 shadow-card">
          ...
          <div className="mt-1 text-xs text-slate-400">Interviews</div>
        </div>
        ...
        <div className="card-hover rounded-2xl border border-slate-200 bg-white p-5 shadow-card">
          ...
          <div className="mt-1 text-xs text-slate-400">Offers</div>
        </div>
        ...
        <div className="card-hover rounded-2xl border border-slate-200 bg-white p-5 shadow-card">
          ...
          <div className="mt-1 text-xs text-slate-400">Rejected</div>
        </div>
      </section>
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-card sm:p-6">
        ...
        {paginatedApplications.length === 0 && (
          <div className="py-16 text-center">
            ...
            <h3 className="mt-4 text-sm font-bold">No applications found</h3>
          ...
          <p className="text-xs text-slate-400">
            ...
            <span className="font-semibold text-slate-700">
              {filteredApplications.length === 0
                ? 0
                : (currentPage - 1) * 6 + 1}
              –{Math.min(currentPage * 6, filteredApplications.length)}
            </span>{" "}
            of{" "}
            <span className="font-semibold text-slate-700">
      ...
      <section className="grid gap-6 lg:grid-cols-[1.4fr_0.6fr]">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-card sm:p-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-base font-bold">Upcoming follow-ups</h2>
          ...
          <div className="mt-5 space-y-3">
            ...
            <div className="flex items-center gap-4 rounded-xl border border-slate-100 bg-slate-50/70 p-4">
              <div className="flex h-11 w-11 shrink-0 flex-col items-center justify-center rounded-xl bg-white shadow-sm">
                ...
                <span className="text-sm font-extrabold">27</span>
              </div>
            ...
            <div className="flex items-center gap-4 rounded-xl border border-slate-100 bg-slate-50/70 p-4">
              <div className="flex h-11 w-11 shrink-0 flex-col items-center justify-center rounded-xl bg-white shadow-sm">
                ...
                <span className="text-sm font-extrabold">29</span>
              </div>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-700 via-indigo-700 to-blue-700 p-6 text-white shadow-lg shadow-violet-200">
          ...
          <div className="relative">
            ...
            <div className="mt-5 text-4xl font-extrabold">16.7%</div>
