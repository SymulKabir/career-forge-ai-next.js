...
export default function LandingPage() {
    ...
    useEffect(() => {
        const handleMouseMove = (event: MouseEvent) => {
            ...
            document.querySelectorAll<HTMLElement>(".orb").forEach(
                (orb, index) => {
    ...
    return (
        <PublicLayout >
            <section className="relative min-h-screen overflow-hidden pt-36 pb-24 hero-grid">
                <div
                    className="orb w-[500px] h-[500px] bg-violet-300 rounded-full -top-40 -left-40"
                />

                <div
                    className="orb w-[450px] h-[450px] bg-cyan-300 rounded-full top-1/3 -right-48"
                />

                <div
                    className="orb w-[350px] h-[350px] bg-indigo-300 rounded-full bottom-0 left-1/3"
                />
                    ...
                    <div className="max-w-4xl mx-auto text-center reveal">
                        <h1 className="font-display text-5xl sm:text-6xl lg:text-8xl font-bold tracking-tight leading-[0.95] text-slate-950">
                            ...
                            <span className="gradient-text">
                                worth getting noticed.
                            </span>
                        </h1>

                        <p className="mt-8 text-base sm:text-lg lg:text-xl text-slate-500 max-w-2xl mx-auto leading-8">
                            Create powerful resumes, CVs and cover letters with AI.
                            Optimize every application for ATS and tailor your profile
                            to the job you actually want.
                        </p>

                        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
                            <Link href='/resume/new' className="primary-button group px-7 py-4 rounded-2xl text-white font-semibold">
                                Create My Resume
                ...
                <div className="max-w-7xl mx-auto px-5 lg:px-8">
                    <div className="max-w-2xl reveal">
                        ...
                        <p className="mt-5 text-slate-500 leading-7">
                            One intelligent platform for building, optimizing and
                            managing every part of your job application.
                        </p>
                    </div>
                        ...
                        <div className="relative grid lg:grid-cols-2 gap-14 items-center">
                            <div>
                                ...
                                <p className="mt-6 text-slate-500 leading-7 max-w-xl">
                                    Analyze your resume against a target job. Discover
                                    missing keywords, improve weak sections and make your
                                    application more machine-readable.
                                </p>
                ...
                <div className="max-w-7xl mx-auto px-5 lg:px-8">
                    <div className="text-center max-w-2xl mx-auto reveal">
                        ...
                        <p className="text-slate-500 mt-5">
                            Build your first resume for free. Upgrade when you need
                            more power.
                        </p>
                    </div>
            ...
            <section className="py-32">
                <div className="max-w-4xl mx-auto px-5 text-center reveal">
                    ...
                    <p className="mt-6 text-slate-500 max-w-xl mx-auto leading-7">
                        Build a professional career profile and create applications
                        that are tailored for the opportunities you want.
                    </p>
