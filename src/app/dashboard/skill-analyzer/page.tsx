    ...
    <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
      <div>
        <h2 className="text-base font-bold">
          Analyze your career target
        </h2>

        <p className="mt-1 text-xs text-slate-400">
          Skill recommendations are calculated against your target
          position.
        </p>
      </div>
        ...
        {categories.map((item) => {
          ...
          return (
            <button
              ...
              type="button"
              onClick={() =>
                setCategory(item.id as "all" | SkillCategory)
              }
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-[11px] leading-5 text-slate-500">
              ...
              could increase your target-role match by an estimated
              9–14%.
            </p>
          </div>
        </div>
        ...
        {[
          ...
          <div key={skill.name}>
            <div className="flex items-center justify-between">
              ...
              <span
                className={`text-[10px] font-bold ${skill.text}`}
              >
                {skill.label}
              </span>
            </div>
    ...
    <div className="mt-8 grid gap-4 md:grid-cols-3">
      ...
      <div className="relative rounded-2xl border border-red-100 bg-red-50/40 p-5">
        ...
        <p className="mt-2 text-xs leading-5 text-slate-400">
          Strengthen your understanding of AWS core services and
      ...
      <div className="relative rounded-2xl border border-violet-100 bg-violet-50/40 p-5">
        ...
        <h3 className="mt-4 text-sm font-bold">
          Expand your API stack
        </h3>

        <p className="mt-2 text-xs leading-5 text-slate-400">
          Add GraphQL and advanced API architecture to your existing
          backend experience.
        </p>
