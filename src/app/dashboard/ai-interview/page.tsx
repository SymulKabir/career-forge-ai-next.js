          ...
          <div className="relative grid gap-8 lg:grid-cols-[1fr_340px] lg:items-center">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500 sm:text-base">
                Practice realistic job interviews with your AI interviewer.
                Get instant feedback on your answers, communication, and
                technical skills.
              </p>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-card sm:p-6">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              ...
              <button className="card-hover group rounded-2xl border border-orange-200 bg-orange-50/50 p-5 text-left">
                ...
                <p className="mt-1 text-xs leading-5 text-slate-400">
                  Upload a job description and practice questions tailored to
                  that role.
                </p>
